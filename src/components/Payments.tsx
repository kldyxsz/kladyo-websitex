...
export default function Payments() {
  ...
  return (
    <section className="w-full py-[72px]" style={{ backgroundColor: "#fafaf9" }}>
      <div className="mx-auto w-full max-w-[1200px] px-6">
        ...
        <div className="mt-[60px] grid grid-cols-1 gap-5 md:grid-cols-2">
          {/* Card 1 */}
          <div className="group flex flex-col gap-6 rounded-2xl border border-black/[0.06] bg-[#F7F7F7] p-5 sm:p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            <div>
              <h3 className="text-[18px] sm:text-[20px] font-semibold text-black leading-snug mb-3">
            ...
            {serverAnimation && (
              <div className="h-28 w-28 sm:h-32 sm:w-32 mx-auto">
          ...
          <div className="group flex flex-col gap-6 rounded-2xl border border-black/[0.06] bg-[#F7F7F7] p-5 sm:p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            {analyticsAnimation && (
              <div className="h-36 sm:h-40 w-full flex items-center justify-center mt-3 overflow-hidden">
          ...
          <div className="group flex flex-col gap-6 rounded-2xl border border-black/[0.06] bg-[#F7F7F7] p-5 sm:p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            <div className="flex items-center overflow-x-auto">
              <span className="rounded-lg bg-gray-200 px-4 py-2 font-mono text-[13px] sm:text-[14px] text-gray-700 whitespace-nowrap">
